...
#ifndef INCLUDE__VT3_POU__FUELTANKCONTROL_H
#define INCLUDE__VT3_POU__FUELTANKCONTROL_H
...
typedef struct
{
	...
	INT              FuelTankSelection_Tout; /*                                          */
	INT              FuelWaterTout;       /*                                          */
	USINT            FuelLevelState;      /*                                          */
	BOOL             Req_Tank1_Valve_Draw; /*                                          */
	BOOL             Req_Tank1_Valve_Return; /*                                          */
	BOOL             Req_Tank2_Valve_Draw; /*                                          */
	BOOL             Req_Tank2_Valve_Return; /*                                          */
	BOOL             Buf_Tank1_Valve_Draw; /*                                          */
	BOOL             Buf_Tank1_Valve_Return; /*                                          */
	BOOL             Buf_Tank2_Valve_Draw; /*                                          */
	BOOL             Buf_Tank2_Valve_Return; /*                                          */
	USINT            Req_Pump_Speed_Command; /*                                          */
	BOOL             Req_Pump_Command;    /*                                          */
	BOOL             Req_FuelWater_Evacuation; /*                                          */
	USINT            TankControlState;    /*                                          */
	USINT            TankControlTout;     /*                                          */
	BOOL             State_TankSelect_Left; /*                                          */
	BOOL             State_TankSelect_Right; /*                                          */
	USINT            TankSelectTout;      /*                                          */
	USINT            EvacuationValve_state; /*                                          */
	UINT             EvacuationValve_tout; /*                                          */
	UINT             EvacuationValve_prd; /*                                          */
	BOOL             Is_WFI_WaterInFuelIndicator; /*                                          */
} FuelTankControl_t;
...
#endif /* INCLUDE__VT3_POU__FUELTANKCONTROL_H */
