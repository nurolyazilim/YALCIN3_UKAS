...
#ifndef INCLUDE__VT3_POU__DATAARRAY_H
#define INCLUDE__VT3_POU__DATAARRAY_H
...
/* data type declaration: dataArray */
typedef UDINT dataArray[100][3];
typedef UDINT dataArray__1[3];

#pragma CONST_SEG DEFAULT
#pragma DATA_SEG DEFAULT


#endif /* INCLUDE__VT3_POU__DATAARRAY_H */
