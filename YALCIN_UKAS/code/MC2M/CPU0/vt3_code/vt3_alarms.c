...
static WORD __afun__0000__(void) { return (DropboxDifflockAlarm); }
static WORD __afun__0001__(void) { return NOT_BOOL((DropboxDifflockAlarm)); }
static WORD __afun__0002__(void) { return (CurrentGear); }
static WORD __afun__0003__(void) { return (VehicleSpeed); }
static WORD __afun__0004__(void) { return (MC2M_TERA_AccessoryPressure); }
static WORD __afun__0005__(void) { return (DropboxFeedbackState); }
static WORD __afun__0006__(void) { return (DropboxDoutState); }
static WORD __afun__0007__(void) { return (DifflockFeedbackState); }
static WORD __afun__0008__(void) { return (DifflockDoutState); }
static WORD __afun__0009__(void) { return (Total_Odometer_Low); }
static WORD __afun__000A__(void) { return (Total_Odometer_High); }
...
static const vt3_alarm_pfn_t FAR __afun__000B__[10] = { (vt3_alarm_pfn_t)NULL, (vt3_alarm_pfn_t)NULL, (vt3_alarm_pfn_t)NULL, (vt3_alarm_pfn_t)NULL, (vt3_alarm_pfn_t)NULL, (vt3_alarm_pfn_t)NULL, (vt3_alarm_pfn_t)NULL, (vt3_alarm_pfn_t)NULL, (vt3_alarm_pfn_t)NULL, (vt3_alarm_pfn_t)NULL };
static const vt3_alarm_pfn_t FAR __afun__000C__[10] = { __afun__0002__, __afun__0003__, __afun__0004__, __afun__0005__, __afun__0006__, __afun__0007__, __afun__0008__, __afun__0009__, __afun__000A__, (vt3_alarm_pfn_t)NULL };
...
const vt3_alarm_definition_t FAR vt3_alarm_definition[] = {
	{
		/* ALARM_INDEX_SPN_SPN_1_FMI_FMI_1 = 0 */
		/* AGUID      */ 0x20000101UL,
		/* priority   */ ALARM_PRIORITY_IDS_ONEMLI,
		/* spn        */ ALARM_SPN_SPN_1,
		/* fmi        */ ALARM_FMI_FMI_1,
		/* group      */ ALARM_GROUP_GROUP_1,
		/* set_trig   */ __afun__0000__, /* DropboxDifflockAlarm */
		/* rtn_trig   */ __afun__0001__, /* !DropboxDifflockAlarm */
		/* on_delay   */    0,
		/* off_delay  */    0,
		/* auto_ack   */ FALSE,
		/* BB1 sa, nr */   0, 0, /*  -- none -- */
		/* BB2 sa, nr */   0, 0, /*  -- none -- */
		/* inhibit    */ 0x0000,
		/* el_values  */ __afun__000C__,
		/* rep_info   */ 0x0000,
		/* rep_safe   */ 0x0000,
	},
	{ 0xFFFFFFFF, 0xFF, 0xFFFF, 0xFF, 0xFF, (vt3_alarm_pfn_t)NULL, (vt3_alarm_pfn_t)NULL, 0, 0, 0, 0, 0, 0, 0, 0, __afun__000B__, 0, 0 } /* end of table */
