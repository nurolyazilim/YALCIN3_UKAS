...
#ifndef INCLUDE__VT3_POU__MAINVVR_H
#define INCLUDE__VT3_POU__MAINVVR_H
...
typedef struct
{
	...
	UINT             vvr_raw_temp;        /*                                          */
	UINT             vvr_raw_pres;        /*                                          */
	INT              coolant_calculated;  /*                                          */
	INT              manifold_calculated; /*                                          */
	UINT             testvar;             /*                                          */
	INT              vvr_temp_calculated; /*                                          */
	INT              vvr_pump_interpolated; /*                                          */
	SINT             pump_trigger;        /*                                          */
	UINT             vvrtestvar;          /*                                          */
} mainVVR_t;
...
#endif /* INCLUDE__VT3_POU__MAINVVR_H */
